// GENERATED AUTOMATICALLY FROM 'Assets/Scripts/Controls and Actions/Controls/PlayerControls.inputactions'
...
public class @PlayerControls : IInputActionCollection, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""b1b10e4e-f02a-4d90-97ce-aaad5a868172"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""1e25cc8b-bb05-40c7-9616-8a59504e0879"",
    ...
    ""controlSchemes"": []
        ...
        m_Mouse_LeftMouseClick = m_Mouse.FindAction("LeftMouseClick", throwIfNotFound: true);
        m_Mouse_MousePosition = m_Mouse.FindAction("MousePosition", throwIfNotFound: true);
        m_Mouse_RightMouseClick = m_Mouse.FindAction("RightMouseClick", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Mouse_LeftMouseClick;
    private readonly InputAction m_Mouse_MousePosition;
    private readonly InputAction m_Mouse_RightMouseClick;
    public struct MouseActions
    {
        private @PlayerControls m_Wrapper;
        public MouseActions(@PlayerControls wrapper) { m_Wrapper = wrapper; }
        public InputAction @LeftMouseClick => m_Wrapper.m_Mouse_LeftMouseClick;
        public InputAction @MousePosition => m_Wrapper.m_Mouse_MousePosition;
        public InputAction @RightMouseClick => m_Wrapper.m_Mouse_RightMouseClick;
        ...
        public void SetCallbacks(IMouseActions instance)
        {
            ...
            {
                @LeftMouseClick.started -= m_Wrapper.m_MouseActionsCallbackInterface.OnLeftMouseClick;
                @LeftMouseClick.performed -= m_Wrapper.m_MouseActionsCallbackInterface.OnLeftMouseClick;
                @LeftMouseClick.canceled -= m_Wrapper.m_MouseActionsCallbackInterface.OnLeftMouseClick;
                @MousePosition.started -= m_Wrapper.m_MouseActionsCallbackInterface.OnMousePosition;
                @MousePosition.performed -= m_Wrapper.m_MouseActionsCallbackInterface.OnMousePosition;
                @MousePosition.canceled -= m_Wrapper.m_MouseActionsCallbackInterface.OnMousePosition;
                @RightMouseClick.started -= m_Wrapper.m_MouseActionsCallbackInterface.OnRightMouseClick;
                @RightMouseClick.performed -= m_Wrapper.m_MouseActionsCallbackInterface.OnRightMouseClick;
                @RightMouseClick.canceled -= m_Wrapper.m_MouseActionsCallbackInterface.OnRightMouseClick;
            }
